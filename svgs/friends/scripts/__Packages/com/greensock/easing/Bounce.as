class com.greensock.easing.Bounce
{
   ...
   {
      return c - com.greensock.easing.Bounce.easeOut(d - t,0,c,d) + b;
   }
   static function easeInOut(t, b, c, d)
   {
      if(t < d * 0.5)
      {
         return com.greensock.easing.Bounce.easeIn(t * 2,0,c,d) * 0.5 + b;
      }
      return com.greensock.easing.Bounce.easeOut(t * 2 - d,0,c,d) * 0.5 + c * 0.5 + b;
   }
}
