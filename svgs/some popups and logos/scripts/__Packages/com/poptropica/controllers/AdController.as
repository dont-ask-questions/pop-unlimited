class com.poptropica.controllers.AdController extends com.poptropica.mvc.AbstractController
{
   ...
   function loadWrapper(offMain)
   {
      if(com.poptropica.models.PopModel(this._model).state == com.poptropica.models.PopAppStates.RETURN_USER_STANDARD && (!com.poptropica.models.PopModel(this._model).gameplayMC.globalScene || offMain == 1))
      {
         if(offMain == undefined)
         {
            offMain = com.poptropica.models.PopModel(this._model).gameplayMC.camera.scene.roomName != "Main Street" ? 1 : 0;
         }
         trace("loadWrapper on island " + _root.island + " offMain:" + offMain);
         if(_root.island == "Lands")
         {
            offMain = 0;
         }
         var _loc4_ = "Off Main";
         ...
         com.poptropica.models.PopModel(this._model).gameplayMC.trackCampaign("AdInventory","AdSpotPresented","Wrapper " + _loc4_);
         this.retrieveAdWrapper(offMain);
      }
   }
   ...
   function onGetCampaigns()
   {
      ...
      if(_loc2_.ad)
      {
         if(_loc3_ != "GlobalAS3Embassy")
         {
            com.poptropica.models.PopModel(this._model).gameplayMC.trackCampaign("AdInventory","AdSpotPresented","Billboard");
         }
      ...
      else if(_loc2_.roomName == "Main Street" || _loc3_ == "GlobalAS3Embassy")
      {
         if(_loc3_ != "GlobalAS3Embassy")
         {
            com.poptropica.models.PopModel(this._model).gameplayMC.trackCampaign("AdInventory","AdSpotPresented","Main Street");
            com.poptropica.models.PopModel(this._model).gameplayMC.trackCampaign("AdInventory","AdSpotPresented","AutoCard");
         }
         ...
         if(_loc2_.vendorCartHolder)
         {
            if(_loc3_ != "GlobalAS3Embassy")
            {
               com.poptropica.models.PopModel(this._model).gameplayMC.trackCampaign("AdInventory","AdSpotPresented","Vendor Cart");
            }
   ...
   function campaignAssetsLoadError(type)
   {
      if(type != com.poptropica.models.AdCampaignType.VENDOR_CART)
      {
         this.resumeGameplayLoading();
      }
   }
   ...
   function retrieveAdWrapper(offMain)
   {
      ...
      this._getAdWrapperCommand.exec(offMain);
   }
